...
- **アカウントを持てるのは、管理者が登録した人だけ。** 招待リンクのような
  仕組みは作らない。こちらで用意していない枠にアカウントが増えることはない
  - 例外は最初の1人だけ。家族がまだ無いときに限り、自分で登録できる
  - ログインさせたい相手には、管理者がメールアドレスとパスワードを決めて伝える
  - 名前だけで登録しておいて、あとからログインを設定することもできる
